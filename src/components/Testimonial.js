...
const Testimonial = () =>
  <div className='testimonals-container'>
    <div className='testimonal'>
      ...
      <p>
        With Free Code Camp&#39;s valuable contribution, we were able to improve
        all of our systems and processes as part of our Wonder Women Eastern
        Indonesia program, and make sure that even more life changing
    ...
    <div className='testimonal'>
      ...
      <p>
        We have been blown away by the professional quality of the work that has
        been produced by the campers working on our projects. Free Code Camp has
        been an invaluable partner and we are grateful for their support.
      </p>
      <p>
